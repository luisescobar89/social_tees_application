...
if($applicant_name == '' || $applicant_date){
...
echo "<p> ID: ".$applicant_id." name: ".$new_applicant_name. " date: " . $applicant_date . "</p>";

if ($result = $mysqli->query("SELECT * FROM applicant_info WHERE id='".$applicant_id."' OR lastname='".$new_applicant_name."' OR DATE='".$applicant_date."'"))
